...
Route::view('/struktur-organisasi', 'guest.struktur-organisasi.index')->name('struktur-organisasi.index.guest');

Route::view('/dokumen-publik', 'guest.dokumen-publik.index')->name('dokumen-publik.index.guest');
