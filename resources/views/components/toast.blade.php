...
{{-- 
<hr class="text-green-500 bg-green-100">
<hr class="text-red-500 bg-red-100">
<hr class="text-yellow-500 bg-yellow-100">
 --}}
 <div id="toast-{{ $type }}" class="fixed bottom-2 right-2 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 opacity-0 transition-opacity duration-500 ease-out" style="display: flex" role="alert">
  ...
  <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" aria-label="Close" data-toast-id="toast-{{ $type }}">
